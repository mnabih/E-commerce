...
class UserController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        User::create($data);
        return redirect(aurl('user'))->with('success', trans('admin.record_added'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(aurl('user'))->with('success', trans('admin.record_updated'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect(aurl('user'))->with('success', trans('admin.deleted_record'));
    }
