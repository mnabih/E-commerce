      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="{{aurl('user')}}"><i class="fa fa-users"></i> {{trans('admin.users')}} </a></li>


            <li class="active"><a href="{{aurl('user')}}?level=user"><i class="fa fa-users"></i> {{trans('admin.user')}} </a></li>
            <li class="active"><a href="{{aurl('user')}}?level=vendor"><i class="fa fa-users"></i>{{trans('admin.vendor')}}</a></li>
            <li class="active"><a href="{{aurl('user')}}?level=company"><i class="fa fa-users"></i> {{trans('admin.company')}} </a>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-flag"></i> <span>{{ trans('admin.areas') }}</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
       ...
       <li class="treeview">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-info"></i> <span>{{ trans('admin.sizes') }}</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu" style="">
            <li class=""><a href="{{ aurl('sizes') }}"><i class="fa fa-info"></i> {{ trans('admin.sizes') }}</a></li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-info"></i> <span>{{ trans('admin.weights') }}</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu" style="">
            <li class=""><a href="{{ aurl('weights') }}"><i class="fa fa-info"></i> {{ trans('admin.weights') }}</a></li>
